...
That is the entire required dependency set. The processing core, its CLI and 427 of its
547 tests run on Python's standard library plus pydantic — verified by
